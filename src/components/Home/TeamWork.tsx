export default function TeamWork() {
  return (
    <section className="mt-0 md:mt-12 lg:mt-8 mb-8 mx-4 lg:mx-12 md:py-14 py-6 px-4 md:rounded-[60px] rounded-2xl relative overflow-hidden bg-quinary ">
      ...
      <div className="w-full mx-auto flex flex-col md:flex-row gap-4 md:gap-4 lg:px-12">
        <div className="bg-white z-10 shadow-xl p-4 lg:p-12 rounded-xl w-full flex-1 font-semibold">
          ...
          <h2 className="text-xl lg:text-2xl font-semibold mb-4 mt-6 text-quinary">
            Colaboradores
          </h2>
        ...
        <div className="bg-white z-10 shadow-xl p-4 lg:p-12 rounded-xl w-full flex-1 font-semibold">
          ...
          <p className="text-base lg:text-lg mt-4">Santiago Suárez Cortes</p>
          <p className="text-sm lg:text-lg italic">Ingeniero Electrónico</p>
          <p className="text-base lg:text-lg mt-4">Catalina Hoyos Ortega</p>
          <p className="text-sm lg:text-lg italic">
            Comunicadora gráfica publicitaria (UX/UI)
          </p>
        </div>
      </div>
    </section>
