...
export default function ShortCutItem({
  ...
  return (
    <>
      <div className="w-full h-[390px] lg:h-[460px] rounded-xl md:rounded-3xl relative overflow-x-hidden flex justify-center items-center">
        ...
        <div className="relative z-10 flex flex-col pt-32 lg:pt-56 items-center justify-between h-full text-white max-w-[236px] font-semibold">
          ...
          <Link
            to={route}
            className="text-lg primary-button md:w-[165px] mb-12 lg:mb-16 text-center"
          >
            Ver más
          </Link>
        </div>
