export default function Statistics() {
  return (
    <div className="mt-20 flex px-4 lg:px-12 xl:px-56 gap-4 lg:gap-8 xl:gap-12">
      ...
      <div className="w-full md:w-[calc(100%-316px)] lg:w-[calc(100%-548px)] font-semibold flex flex-col xl:pr-12 [&>p]:text-lg [&>p]:lg:text-xl [&>p]:text-septenary [&>p]:mt-5">
        ...
        <h3 className="mt-4 w-[100px] lg:w-[165px] py-2 lg:py-5 bg-primary text-white text-center cursor-pointer lg:rounded-3xl rounded-xl text-xl justify-self-end lg:mt-auto transition-all duration-200 ease-in-out hover:shadow-lg hover:scale-105">
          Ver más
        </h3>
      </div>
    </div>
