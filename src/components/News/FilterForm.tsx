...
export default function FilterForm({
  ...
  if (interventions)
    return (
      <form className="urban-planning-interventions__form w-full mt-6 grid grid-cols-1 md:grid-cols-2 rounded-lg border shadow-sm items-center p-6 gap-6 justify-between">
